...
//	int temp;
	...
	unsigned int numCodePage, numDataPage; // sốtrang cho phần code và phần initData 
	int lastCodePageSize, lastDataPageSize, firstDataPageSize,tempDataSize; // kích 
	//thước ghi vào trang cuối Code, init Data, và trang đầu của initData 
